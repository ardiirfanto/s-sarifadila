...
@section('content')
    ...
    @endif
    <div class="mb-2">
        <a href="{{ route('tambahmateri') }}"
            class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm p-1 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 px-3">
            Tambah Materi
        </a>
    </div>
            ...
            <div class="border rounded-lg py-5 xl:px-5 px-3 mb-4">
                <div class="flex flex-row gap-2 mb-2">
                    <div class="product-thumbnail d-block">
                        <img class="w-20 h-20 rounded-lg" src="{{ asset('assets/img/materi/' . $item->gambar) }}"
                            alt="">
                    </div>
                    <div class="flex flex-col justify-between">
                        ...
                        <div>
                            <button onclick="setDelRoute('{{ route('materi.delete', ['id' => $item->id]) }}')"
                ...
                <div class="mt-2">
                    <a href="{{ route('kelolasubmateri', ['materiid' => $item->id]) }}"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-1 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 px-3">
                        Lihat Sub Materi
                    </a>
                </div>
            </div>
    ...
    <footer>
        <div
            ...
            <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
                ...
                <a href="https://smkn5dumai.sch.id/" type="button"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Menghapus Materi akan menghapus
