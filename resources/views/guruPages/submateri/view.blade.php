            ...
            <div class="border rounded-lg py-5 xl:px-5 px-3 mb-4">
                <div class="flex flex-row gap-2 mb-2">
                    <div class="product-thumbnail d-block">
                        <img class="w-20 h-20 rounded-lg" src="{{ asset('assets/img/submateri/' . $item->gambar) }}"
                            alt="">
                    </div>
                    <div class="flex flex-col justify-between">
                        ...
                        <div>
                            <button onclick="setDelRoute('{{ route('submateri.delete', ['id' => $item->id]) }}')"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Menghapus Sub Materi akan
                        menghapus
