                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                <div class="card team-member-card shadow">
                                    ...
                                    <div class="contact-info bg-primary">
                                        ...
                                        <a class="btn btn-creative btn-warning" href="/dashboard/videomateri">Update Video
                                            Materi</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="card team-member-card shadow">
                                    ...
                                    <!-- Contact Info-->
                                    <div class="contact-info bg-primary">
                                        <a class="btn btn-creative btn-warning" href="/dashboard/kuis">Update Materi
                                            Kuis</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="card team-member-card shadow">
                                    ...
                                    <!-- Contact Info-->
                                    <div class="contact-info bg-info">
                                        <a class="btn btn-creative btn-warning" href="/dashboard/hasil-kuis">Update Hasil
                                            Kuis</a>
                                    </div>
                                </div>
                            </div>
