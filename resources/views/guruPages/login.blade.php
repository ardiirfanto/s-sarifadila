                ...
                <div class="form-group">
                    ...
                    <form method="POST" action="/loginProcess">
                        ...
                        <div class="form-group">
                            ...
                            <input value="" type="email" name="email" placeholder="Enter Email" class="form-control"
                                id="email">
                        </div>
                        <div class="form-group">
                            <label for="password" class="text-white"></label>
                            <input value="" type="password" name="password" placeholder="Enter Password" class="form-control"
                                id="password">
                        </div>
