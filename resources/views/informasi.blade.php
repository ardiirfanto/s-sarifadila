...
<body class="bg-light d-flex flex-column vh-100">
                    ...
                    <div class="container px-0 px-xl-3">
                        <div class="offcanvas offcanvas-start p-4 p-lg-0" id="navbar-default">
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="lh-sm">
                                            ...
                                            <p class="text-muted m-0 text-truncate d-inline-block mb-0 align-bottom">
                                                H.No. 2834 Street, 784 Sector, Ludhiana, Punjab</p>
                                        </div>
                            ...
                            <div class="d-block d-lg-none mb-3">
                                <a class="btn btn-danger d-flex align-items-center rounded-pill w-100"
                            ...
                            <div class="d-block d-lg-none h-100" data-simplebar="">
                                <ul class="navbar-nav ">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="listing.html">Shop Grid - Filter</a>
                                            </li>
                                            ...
                                            <li><a class="dropdown-item" href="product-detail.html">Shop Single</a>
                                            </li>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="dropdown-submenu ">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="listing.html">Milk Drinks</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="listing.html">Curd & Yogurt</a>
                                                    </li>
                                                    <li> <a class="dropdown-item" href="listing.html">Eggs</a></li>
                                                    <li><a class="dropdown-item" href="listing.html">Buns & Bakery</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="listing.html">Cheese</a></li>
                                                    <li> <a class="dropdown-item" href="listing.html">Condensed
                                                            Milk</a></li>
                                                    <li><a class="dropdown-item" href="listing.html">Dairy
                                                            Products</a></li>
                                                </ul>
                                            </li>
                                            <li class="dropdown-submenu ">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="listing.html">Vegetables</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="listing.html">Fruits</a></li>
                                                    <li> <a class="dropdown-item" href="listing.html">Exotics &
                                                            Premium</a></li>
                                                    <li><a class="dropdown-item" href="listing.html">Fresh Sprouts</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="listing.html">Frozen Veg</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="dropdown-submenu ">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="listing.html">Soft Drinks</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="listing.html">Fruit Juices</a>
                                                    </li>
                                                    <li> <a class="dropdown-item" href="listing.html">Coldpress</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="listing.html">Soda & Mixers</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="listing.html">Milk Drinks</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="listing.html">Health Drinks</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="listing.html">Herbal Drinks</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="dropdown-submenu dropend">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a class="dropdown-item" href="my-wallet.html">My Wallet</a>
                                                    </li>
                                                    <li><a class="dropdown-item"
                                                            href="account-notification.html">Notification</a></li>
                                                </ul>
                                            </li>
                                            <li><a class="dropdown-item" href="my-account.html">My Account Tabs</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                        ...
                        <div class="top-picks">
                                ...
                                <div class="card bg-transparent border-0 overflow-hidden h-100 mx-2">
                                    <a href="product-detail.html" class="link-dark">
                                        <div class="rounded-4 p-2 position-relative product-box bg-white">
                                            <img src="img/list/9.jpeg" alt=""
                                                class="img-fluid h-100 d-block mx-auto">
                                        </div>
                                    </a>
                                    <div
                                        class="bg-info position-absolute top-0 text-white osahan-badge text-center mx-3">
                                        <b>2%</b><br>OFF
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <a data-bs-toggle="offcanvas" data-bs-target="#mycart" aria-controls="mycart"
                                            href="cart.html"
                                            class="btn btn-outline-danger btn-sm rounded-3 fw-bold px-4 osahan-new-btn">ADD</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="top-picks-item">
                                <div class="card bg-transparent border-0 overflow-hidden h-100 mx-2">
                                    <a href="product-detail.html" class="link-dark">
                                        <div class="rounded-4 p-2 position-relative product-box bg-white">
                                            <img src="img/list/10.jpeg" alt=""
                                                class="img-fluid h-100 d-block mx-auto">
                                        </div>
                                    </a>
                                    <div
                                        class="bg-success position-absolute top-0 text-white osahan-badge text-center mx-3">
                                        <b>4%</b><br>OFF
                                    </div>
                                    <div class="card-body pt-1 px-0">
                            ...
                            <div class="top-picks-item">
                                <div class="card bg-transparent border-0 overflow-hidden h-100 mx-2">
                                    <a href="product-detail.html" class="link-dark">
                                        <div class="rounded-4 p-2 position-relative product-box bg-white">
                                            <img src="img/list/11.jpeg" alt=""
                                                class="img-fluid h-100 d-block mx-auto">
                                        </div>
                                    </a>
                                    <div
                                        class="bg-secondary position-absolute top-0 text-white osahan-badge text-center mx-3">
                                        <b>4%</b><br>OFF
                                    </div>
                                    <div class="card-body pt-1 px-0">
                                        <p class="text-muted mb-1">Fortune</p>
                        ...
                        <div class="row g-0">
                            <div class="col-lg-4 d-none d-lg-block">
                                <div
                                    ...
                                    <a href="#"
                                        class="btn btn-sm w-100 btn-warning mt-auto rounded-pill">Download App</a>
                                </div>
                            </div>
                                ...
                                <form>
                                    <div class="text-start">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <span class="small">
                                                <a href="#" class="text-decoration-underline me-2">Terms of
                                                    service</a>
                            ...
                            <div class="col-lg-8 p-4">
                                <div class="mb-4">
                                    <h6 class="fw-bold d-flex align-items-center text-danger mb-1"><a class="me-3"
                                            href="#" data-bs-target="#login" data-bs-toggle="modal"><i
                                    ...
                                    <div class="text-start">
                                        ...
                                        <div class="mt-3">
                                            <span class="small d-flex justify-content-between">
                                                <a href="#" class="text-decoration-underline me-2">Resend
                                                    Code</a>
                                                <small class="text-muted">Resend Code (in <b id="timer">60</b>
                                                    secs)</small>
                                            </span>
                                        </div>
                                    </div>
        ...
        <div class="offcanvas offcanvas-end my-cart-width" tabindex="-1" id="mycart">
            ...
            <div class="offcanvas-footer p-4">
                <a href="#"
                    ...
                    data-bs-toggle="offcanvas" data-bs-target="#myaddress" aria-controls="myaddress">3 items &#183;
                    $130
        ...
        <div class="offcanvas offcanvas-end my-cart-width" tabindex="-1" id="myaddress">
            ...
            <div class="offcanvas-body p-0">
                ...
                <div class="px-4 py-2 bg-light">
                    <div
                        ...
                        <input class="form-check-input" type="radio" name="aaflexRadioDefault"
                            id="aaflexRadioDefault1">
                        ...
                        <div class="osahan-radio-box-inner">
                            <div class="d-flex align-items-center justify-content-between bg-white">
                                <div class="w-75">
                                    <div class="d-flex align-items-center gap-3 osahan-mb-1">
                                        ...
                                        <div class="pe-4 overflow-hidden">
                                            <h6 class="fw-bold mb-1">Mr David - <span
                                                    class="fw-light small">Home</span></h6>
                                ...
                                <div class="ms-auto gap-2 mt-auto text-center small">
                                    <a href="#" class="small d-flex align-items-center gap-1"
                                        data-bs-toggle="modal" data-bs-target="#addaddress"><i
                                            class="lni lni-pencil-alt d-flex"></i>Edit</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div
                        class="form-check osahan-radio-box-action osahan-radio-box w-100 bg-white border p-3 my-3 rounded-4">
                        <input class="form-check-input" type="radio" name="aaflexRadioDefault"
                            id="aaflexRadioDefault2" checked="">
            ...
            <div class="offcanvas-footer p-4">
                <a href="#" class="btn btn-danger fw-bold py-3 px-4 w-100 rounded-4 shadow"
                    data-bs-toggle="offcanvas" data-bs-target="#mycardwithaddress"
                    aria-controls="mycardwithaddress">Done</a>
            </div>
        </div>
        ...
        <div class="offcanvas offcanvas-end my-cart-width" tabindex="-1" id="mycardwithaddress">
            ...
            <div class="offcanvas-footer border-top p-4">
                <div class="d-flex align-items-center gap-3 pb-3">
                    ...
                    <a href="#" data-bs-toggle="offcanvas" data-bs-target="#myaddress"
                        aria-controls="myaddress" class="ms-auto">Change</a>
                </div>
                <a href="checkout.html"
                    class="btn btn-danger fw-bold d-flex align-items-center justify-content-between py-3 px-4 w-100 rounded-4 shadow">3
                    items &#183; $130 <span>Proceed To Pay<i class="icofont-double-right ms-1"></i></span>
                </a>
            </div>
        </div>
                        ...
                        <div class="row g-0">
                            <div class="col-lg-6">
                                <div class="ratio ratio-1x1 h-100">
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1750606.6319414608!2d74.2897923755259!3d31.02197051025034!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391964aa569e7355%3A0x8fbd263103a38861!2sPunjab!5e0!3m2!1sen!2sin!4v1677160520792!5m2!1sen!2sin"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <label class="btn btn-outline-secondary btn-sm"
                                                for="btnradio1">Home</label>
                                            <input type="radio" class="btn-check" name="btnradio"
                                                id="btnradio2">
                                            <label class="btn btn-outline-secondary btn-sm"
                                                for="btnradio2">Office</label>
                                            <input type="radio" class="btn-check" name="btnradio"
                                                id="btnradio3">
                                            <label class="btn btn-outline-secondary btn-sm"
                                                for="btnradio3">Other</label>
                                        </div>
                                    </div>
                                    <a href="#"
                                        class="btn btn-danger fw-bold py-3 px-4 w-100 rounded-4 shadow"
                                        data-bs-dismiss="modal" aria-label="Close">Save Address</a>
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    <script src="{{ asset(' ../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min-1.js') }}"
        data-cf-settings="5948870de05fe4f942bef8f7-|49" defer=""></script>
    <script defer="" src="{{ asset('../../beacon.min.js/v84a3a4012de94ce1a686ba8c167c359c1696973893317-1') }}"
        integrity="sha512-euoFGowhlaLqXsPWQ48qSkBSCFs3DPRyiwVu3FjR96cMPx+Fr+gpWRhIafcHwqwCqWS42RZhIudOvEI+Ckf6MA=="
        data-cf-beacon='{"rayId":"858bc067fdd59e38","r":1,"version":"2024.2.1","token":"dd471ab1978346bbb991feaa79e6ce5c"}'
