            ...
            <div class="row g-3 justify-content-center">
                ...
                <div class="col-12 col-md-8 col-lg-7 col-xl-6 btn-click" id="pelmat-1">
                    <div class="card shadow-sm blog-list-card">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="card-blog-img position-relative" style="background-image: url('img/bg-img/mjasmani.jpg')">
                                <span class="badge bg-warning text-dark position-absolute card-badge">Agency</span>
                            </div>
                            <div class="card-blog-content">
                                <span class="badge bg-danger rounded-pill mb-2 d-inline-block">KEBUGARAN JASMANI</span>
                                <a class="blog-title d-block mb-3 text-dark">HAKIKAT PENCAK SILAT </a>
                                <button onclick="animateBtnPelajaran('pelmat-1','pelajaran-5/senam-lantai-lokomotor1')"
                ...
                <div class="col-12 col-md-8 col-lg-7 col-xl-6 btn-click" id="pelmat-2">
                    <div class="card shadow-sm blog-list-card">
                        <div class="d-flex align-items-center">
                            <div class="card-blog-img position-relative"
                                style="background-image: url('img/bg-img/latihan.jpg')">
                                <span class="badge bg-warning text-dark position-absolute card-badge">Business</span>
                            </div>
                            <div class="card-blog-content">
                                <span class="badge bg-danger rounded-pill mb-2 d-inline-block">KEBUGARAN JASMANI</span>
                                <a class="blog-title d-block mb-3 text-dark">KETERAMPILAN GERAK
                                </a>
                                <button onclick="animateBtnPelajaran('pelmat-2','pelajaran-5/senam-lantai-nonlokomotor1')"
                                    class="btn btn-primary btn-sm">
                                    BUKA MATERI
                                </button>
                            </div>
                ...
                <div class="col-12 col-md-8 col-lg-7 col-xl-6 btn-click" id="pelmat-3">
                    <div class="card shadow-sm blog-list-card">
                        <div class="d-flex align-items-center">
                            <div class="card-blog-img position-relative"
                                style="background-image: url('img/bg-img/tes.jpg')">
                                <span class="badge bg-warning text-dark position-absolute card-badge">World</span>
                            </div>
                            <div class="card-blog-content">
                                <span class="badge bg-danger rounded-pill mb-2 d-inline-block">KEBUGARAN JASMANI</span>
                                <a class="blog-title d-block mb-3 text-dark">KETERAMPILAN GERAK BELAAN</a>
                                <button onclick="animateBtnPelajaran('pelmat-3','pelajaran-5/manipulatif-senam-lantai1')"
                                    class="btn btn-primary btn-sm">
                                    BUKA MATERI
                                </button>
                            </div>
