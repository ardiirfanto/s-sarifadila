...
@section('content')
    <div class="grid grid-cols-12 gap-3">
        <div class="md:col-span-6 xl:col-span-3 col-span-12">
            <a href="pelajaran-2/gerak-nonlokomotor">
                <div class="bg-sky-900 h-full shadow-lg rounded-lg border p-4">
                    ...
                    <h1 class="text-xl text-center text-white font-bold mt-4 uppercase">Gerak Nonlokomotor</h1>
                </div>
            </a>
        </div>
        <div class="md:col-span-6 xl:col-span-3 col-span-12">
            <a href="pelajaran-2/gerak-dasar-nonlokomotor">
                <div class="bg-sky-900 h-full shadow-lg rounded-lg border p-4">
                    <svg class="w-20 text-white block mx-auto" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M6 2a2 2 0 0 0-2 2v15a3 3 0 0 0 3 3h12a1 1 0 1 0 0-2h-2v-2h2c.6 0 1-.4 1-1V4a2 2 0 0 0-2-2h-8v16h5v2H7a1 1 0 1 1 0-2h1V2H6Z" clip-rule="evenodd"/>
                    </svg>
                    <h1 class="text-xl text-center text-white font-bold mt-4 uppercase">Gerak Dasar Nonlokomotor</h1>
                </div>
            </a>
        </div>
        <div class="md:col-span-6 xl:col-span-3 col-span-12">
            <a href="pelajaran-2/permainan-gerak-nonlokomotor">
                <div class="bg-sky-900 h-full shadow-lg rounded-lg border p-4">
                    <svg class="w-20 text-white block mx-auto" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M6 2a2 2 0 0 0-2 2v15a3 3 0 0 0 3 3h12a1 1 0 1 0 0-2h-2v-2h2c.6 0 1-.4 1-1V4a2 2 0 0 0-2-2h-8v16h5v2H7a1 1 0 1 1 0-2h1V2H6Z" clip-rule="evenodd"/>
                    </svg>
                    <h1 class="text-xl text-center text-white font-bold mt-4 uppercase">Permainan Dalam Gerak Nonlokomtor</h1>
                </div>
            </a>
        </div>
    </div>
