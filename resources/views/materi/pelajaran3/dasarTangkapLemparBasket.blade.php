...
@section('content')
    <h1 class="text-xl text-orange-700 font-bold">A. Hakikat Atletik</h1>
...
gerakan dasar yang dinamis dan harmonis, di antaranya jalan cepat,
lari, lompat, dan lempar. Berdasarkan istilah, atletik berasal dari
bahasa Yunani, yaitu athlon atau athlun yang artinya lomba atau
perlombaan/pertandingan. Di Amerika dan sebagian negara di benua
Eropa serta benua Asia sering memakai kata atletik dengan istilah
Track and Field, sedangkan untuk negara di benua Eropa, khususnya
Jerman menggunakan Leicht Athletik dan Belanda menggunakan
istilah Athletiek..
    </p>
    <h1 class="text-lg text-red-700 font-bold">1. Nomor Jalan Cepat dan lari</h1>
    <b style="color: black;">A. Jalan Cepat</b>
    <p class="text-justify">

    Jalan cepat adalah gerak maju dengan melangkah tanpa
adanya hubungan terputus dengan tanah. Jadi, kaki depan harus
menyentuh tanah setaip melangkah sebelum kaki belakang
meninggalkan tanah. Jalan cepat untuk putri adalah 10 km dan
20 km, sedangkan jalan cepat untuk putra adalah 20 km dan
50 km.
    </p>

    <b style="color: black;">B. Nomor Lari</b>
    <p class="text-justify">

Cabang olahraga yang termasuk nomor lari dalam atletik
antara lain sebagai berikut.
<ul class="ms-8 list-decimal">
                <li>
                Lari jarak pendek (sprint) 50-400 m.
                </li>
                <li>
                Lari jarak menengah (middle distance) 800-1.500 m.
                </li>
                <li>
                Lari jarak jauh (ong distance) 3.000-42.195 km (maraton).
                </li>
            </ul>
    </p>

    <h1 class="text-lg text-red-700 font-bold mt-5">2. Sarana dan Prasarana Lari</h1>
    <p class="text-justify">
    Lintasan lari dapat dilakukan, baik di dalam maupun di luar
ruangan. Lintasan lari di dalam ruangan umumnya terdiri atas empat
atau enam jalur. Belokan dalam lintasan lari di dalam ruangan juga
sering kali dibuat lurus untuk mengompensasikan belokan yang
ketat. Sementara itu, linta san lari di luar ruangan sebagian besar
berbentuk oval. Pada umumnya, lintasan menggunakan enam sampai
10 jalur, termasuk sebuah jalur langkah dan selokan di salah satu
belokan.
<img src="{{ url('assets/lapanganlari.JPG') }}" class="block mx-auto mt-5" alt="">
