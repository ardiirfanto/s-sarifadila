...
@section('content')
    <h1 class="text-xl text-orange-700 font-bold">D. Lompat Jauh</h1>
    ...
    <h1 class="text-lg text-red-700 font-bold">1. Pengertian Lompat Jauh</h1>
    <p class="text-justify">

    Lompat jauh adalah nomor olahraga atletik lompat yang menun-
tut keterampilan melompat ke depan sejauh-jauhnya dengan satu
kali tolakan. Dalam olahraga lompat jauh, diperlukan tempat yang
terdiri atas lintasan lari untuk melakukan ancang-ancang, papan
tolakan, dan landasan/bak pasir untuk mendarat. Ukuran panjang
lintasan lari untuk ancang-ancang, yaitu 40-45 m dan lebar 1,2 m.
sedangkan panjang minimal bak pasir, yaitu 9 m dan lebar 2,75-3 m.
Papan tolakan terbuat dari kayu atau bahan lain yang memiliki
kekuatan dan permukaan yang hampir sama. Lebar papan tolakan
10 cm, panjang 1,2 m, dan tebal 1,5 cm yang harus terpasang timbul
setinggi 8 mm di atas permukaan tanah yang ditanam sedalam 7
mm. 
    </p>

    <h1 class="text-lg text-red-700 font-bold mt-5">2. Sarana dan Prasarana</h1>
    <p class="text-justify">
    
    
    Sarana dan prasarana lompat jauh antara lain sebagai berikut.
    <ul class="ms-8 list-decimal">
                ...
                <li>
                Pada sisi dekat dengan tempat mendarat harus diletakkan papan
plastisin untuk mencatat bekas lompatan pelompat. plastisin tersebut ditujukan agar dapat terlihat apabila pelompat
berbuat salah dalam melakukan tolakan. Papan tolakan harus
dicat putih dan harus datar dengan tanah serta harus ditanam
sekurang-kurangnya 1 m dari tepi depan bak pasir pendaratan.
                </li>
                
<img src="{{ url('assets/papanjauh.JPG') }}" class="block mx-auto mt-5" alt="">
    <p class="text-center">Gambar 1.2</p>
    <li>
                Lebar tempat pendaratan minimum 2,75 m dan jarak antara
garis tolakan sampai akhir tempat lompatan minimal 10 m.
                </li>
                <li>
                Permukaan pasir di dalam tempat pendaratan harus sama tinggi/
