...
@section('content')
    <h1 class="text-xl text-orange-700 font-bold">C. Lari Menengah</h1>
    ...
    Perlombaan lari jarak menengah diselenggarakan dengan
jarak 800 m, 1.500 m, dan 3.000 m. Pelari jarak menengah harus
mempunyai kecepatan dan daya tubuh yang baik karena pelari harus
mengatur kecepatan berlari agar tidak cepat lelah. Beberapa atlet lari
jarak menengah yang terkenal di dunia, di antaranya Paavo Nurmi
(Finlandia), Roger Bannister (Inggris), dan Jim Ryun (Amerika Serikat).
    </p>

    <h1 class="text-lg text-red-700 font-bold mt-5">1. Keterampilan Gerak lari jarak Menengah</h1>
    <b style="color: black;">A. Star Lari Jarak Menengah</b>
    <p class="text-justify">
    <ul class="ms-8 list-decimal">
    <li>
                Peraturan mengenai batas lintasan lari jarak menengah dapat
diabaikan. Artinya, pelari dapat melakukan perpindahan
lintasan sesuai keinginan dan situasi di perlombaan.
                </li>
                <li>
                Gerakan awal dimulai dari gerak melangkah ke depan dengan
menempatkan kaki kiri di belakang garis start
                </li>
                <li>
                Lutut agak dibengkokkan dan kaki kanan lurus ke belakang.
                </li>
                <li>
                Badan condong ke depan, pandangan ke depan dan leher
dalam keadaan rileks.
                </li>
                <li>
                Pada saat mendengar aba-aba "Ya" atau suara pistol, pelari
berlari secepat-cepatnya
                </li>
                <li>
                Pada saat berlari, usahakan kaki tetap lurus, langkah kaki
pendek, dan tubuh tidak terlalu membungkuk ke depan.
                </li>
                <li>
                Peraturan mengenai batas lintasan lari jarak menengah dapat
diabaikan. Artinya, pelari dapat melakukan perpindahan
