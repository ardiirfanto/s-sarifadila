            ...
            <div class="row g-3 justify-content-center">
                    ...
                    <div class="card shadow-sm blog-list-card">
                        <div class="d-flex align-items-center">
                            <div class="card-blog-img position-relative"
                                style="background-image: url('img/bg-img/maraton.jpg')">
                                <span class="badge bg-warning text-dark position-absolute card-badge">Agency</span>
                            </div>
                            <div class="card-blog-content">
                                <span class="badge bg-danger rounded-pill mb-2 d-inline-block">ATLETIK</span>
                                <a class="blog-title d-block mb-3 text-dark">HAKIKAT ATLETIK </a>
                                <button
                                    onclick="animateBtnPelajaran('pelmat-1','pelajaran-3/dasar-tangkap-lempar-basket')"
                ...
                <div class="col-12 col-md-8 col-lg-7 col-xl-6 btn-click" id="pelmat-2">
                    <div class="card shadow-sm blog-list-card">
                        <div class="d-flex align-items-center">
                            <div class="card-blog-img position-relative"
                                style="background-image: url('img/bg-img/pendek.png')">
                                <span class="badge bg-warning text-dark position-absolute card-badge">Business</span>
                            </div>
                            <div class="card-blog-content">
                                <span class="badge bg-danger rounded-pill mb-2 d-inline-block">ATLETIK</span>
                                <a class="blog-title d-block mb-3 text-dark">LARI JARAK PENDEK
                                </a>
                                <button
                                    onclick="animateBtnPelajaran('pelmat-2','pelajaran-3/dasar-tangkap-lempar-kasti')"
                ...
                <div class="col-12 col-md-8 col-lg-7 col-xl-6 btn-click" id="pelmat-3">
                    <div class="card shadow-sm blog-list-card">
                        <div class="d-flex align-items-center">
                            <div class="card-blog-img position-relative"
                                style="background-image: url('img/bg-img/menengah.jpg')">
                                <span class="badge bg-warning text-dark position-absolute card-badge">World</span>
                            </div>
                            <div class="card-blog-content">
                                <span class="badge bg-danger rounded-pill mb-2 d-inline-block">ATLETIK</span>
                                <a class="blog-title d-block mb-3 text-dark">LARI JARAK MENENGAH</a>
                                <button
                                    onclick="animateBtnPelajaran('pelmat-3','pelajaran-3/dasar-tangkap-lempar-kastil')"
                                    class="btn btn-primary btn-sm">
                                    BUKA MATERI
                                </button>
                            </div>
                ...
                <!-- Single Blog Card -->
                <div class="col-12 col-md-8 col-lg-7 col-xl-6 btn-click" id="pelmat-4">
                    <div class="card shadow-sm blog-list-card">
                        <div class="d-flex align-items-center">
                            <div class="card-blog-img position-relative"
                                style="background-image: url('img/bg-img/lompat.jpg')">
                                <span class="badge bg-warning text-dark position-absolute card-badge">Fashion</span>
                            </div>
                            <div class="card-blog-content">
                                <span class="badge bg-danger rounded-pill mb-2 d-inline-block">ATLETIK</span>
                                <a class="blog-title d-block mb-3 text-dark" href="blog-details.html">LOMPAT JAUH</a>
                                <button
                                    onclick="animateBtnPelajaran('pelmat-4','pelajaran-3/dasar-tangkap-lempar-kastis')"
                                    class="btn btn-primary btn-sm">
                                    BUKA MATERI
                                </button>
                            </div>
