...
@section('content')
    <h1 class="text-xl text-orange-700 font-bold">A. Hakikat Pencak Silat</h1>
...
dari Indonesia. Seni bela diri ini dikenal luas dan berkembang
dalam masyarakat rumpun Melayu, yakni penduduk asli negara-
nogara Indonesia, Malaysia, Singapura, dan Brunei Darussalam. Di
keempat negara tersebut, pencak silat cukup populer dan dikenal
sebagai olahraga rakyat. Dari keempat negara tersebut, pencak silat
diperkenalkan ke negara-negara lain hingga akhirnya terbentuk
sebuah wadah pencak silat internasional.
Pada awalnya, pencak silat dikembangkan dengan tujuan
mempertahankan atau membela diri dari berbagai ancaman,
khususnya yang datang dari orang lain. Seiring perkembangan
peradaban masyarakat rumpun Melayu, fungsi pencak silat pun
semakin meluas. Pencak silat bukan lagi hanya berfungsi sebagai alat
bela diri (teknis), tetapi juga sebagai sarana berolahraga (atletika).
    </p>
    <img src="{{ url('assets/pencak.jpg') }}" class="block mx-auto w-72 mt-4" alt="">
    <p class="text-center">Gambar 5.1</p>
    <p class="text-justify">
    mencurahkan kecintaan pada rasa keindahan gerak (estetika), serta
sebagai sarana pendidikan mental dan rohani (etika). Berbagai aspek
yang terdapat dalam pencak silat kini telah berkembang lebih jauh.
meliputi aspek-aspek mental spiritual, bela diri, seni, dan olahraga.
Keempat aspek tersebut terjalin dalam suatu rangkaian yang utuh
tidak dapat dipisahkan, saling mengisi, dan saling membutuhkan.
    </p>
