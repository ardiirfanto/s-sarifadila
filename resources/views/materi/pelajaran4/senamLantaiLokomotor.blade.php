...
@section('content')
    <h1 class="text-xl text-orange-700 font-bold">A. Gerak Dasar Lokomotor Senam Lantai</h1>
    ...
    <h1 class="text-lg text-sky-700 font-bold">1. Gerak Dasar Melompat dan Bertumpu</h1>
