...
@section('content')
    <h1 class="text-xl text-orange-700 font-bold">B. Keterampilan Gerak Pencak Silat</h1>
    ...
    Salah satu faktor yang memengaruhi prestasi pencak silat
adalah kemampuan menguasai keterampilan gerak secara sempurna.
Penyajian materi keterampilan gerak pencak silat akan diawali dengan
sikap dasar pencak silat, yaitu sikap kuda-kuda dan sikap pasang.
    </p>
    <h1 class="text-lg text-red-700 font-bold mt-5">1. Sikap Kuda Kuda</h1>
    <p class="text-justify">
    
    Sikap kuda-kuda adalah keterampilan gerak yang memperlihatkan
kaki dalam keadaan statis. Kuda-kuda merupakan keterampilan gerak
yang sangat penting dalam pencak silat. Kuda-kuda menekankan
pentingnya penempatan posisi kaki dengan berbagai bentuk dan
kemampuannya dalam menopang berat badan. Selain itu, kuda-kuda
juga mendukung proses pelaksanaan gerakan pencak silat lainnya, baik
ketika bertahan maupun menyerang. Tinjauan terhadap kuda-kuda dapat
dikaji dari dua segi, yaitu dari segi bobot dan segi bentuk.
<img src="{{ url('assets/kuda.png') }}" class="block mx-auto mt-5" alt="">
