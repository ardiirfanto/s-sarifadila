...
@section('content')
    <h1 class="text-xl text-orange-700 font-bold">C. Keterampilan Gerak Belaan dalam Pencak Silat</h1>
    ...
    Istilah 'serang bela" terdengar ketika sedang membicarakan
keterampilan gerak pencak silat.
Serang bela merupakan suatu istilah
untuk menggambarkan suatu proses yang terjadi dalam pertandingan
pencak silat. diawali serangan terlebih dahulu, kemudian dilakukan
indakan belaan atau sebaliknya. Oleh PB IPSI, belaan didefinisikan
cehagai suatu upaya menggagalkan serangan lawan dengan tangkisan
un bindaran. Belaan dalam peraturan pencak silat dinilai sebagai
keterampilan gerak yang sulit. Dalam pertandingan, suatu serangan
didahului oleh keterampilan gerak belaan dan serangan yang
yang
masuk ke sasaran akan mendapat nilai +1.
    </p>

    <h1 class="text-lg text-red-700 font-bold mt-5">1. Hindaran</h1>
    <p class="text-justify">
    Hindaran adalah keterampilan gerak menggagalkan serangan
lawan yang dilakukan tanpa menyentuh tubuh lawan. Keterampilan
gerak hindaran merupakan koordinasi seluruh anggota tubuh
dengan sempurna. Tujuan dari keterampilan gerak hindaran adalah
mementahkan serangan lawan. Hindaran memerlukan unsur-
unsur kecepatan, kelincahan, kelentukan, dan waktu yang tepat.
Keterampilan gerak hindaran terdiri dan egosan, elakan, dan kelitan.
<img src="{{ url('assets/hindaran.JPG') }}" class="block mx-auto mt-5" alt="">
    <p class="text-center">Gambar 1.2</p>
    </p>
    
    <h1 class="text-lg text-red-700 font-bold mt-5">2. Tangkisan</h1>
    <p class="text-justify">
    Tangkisan adalah keterampilan gerak belaan untuk menggagalkan
serangan lawan menggunakan tangan, kaki, dan tubuh. Terdapat
sebelas tangkisan yang diakui secara nasional, yaitu tangkisan tepis,
gedik, kelit, siku, jepit, potong, saga, galang, kepruk, kibas, dan lutut.
<img src="{{ url('assets/tangkisan.JPG') }}" class="block mx-auto mt-5" alt="">
    <p class="text-center">Gambar 1.2</p>
    </p>
