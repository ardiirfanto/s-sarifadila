...
@section('content')
    <h1 class="text-xl text-orange-700 font-bold">C. Bola Tangan Indoor</h1>
    ...
    <h1 class="text-lg text-red-700 font-bold">1. Hakikat Permainan Bola Tangan Indoor</h1>
    <p class="text-justify">

    Bermainan bola tangan indoor (indoor handball) merupakan
salah satu olahraga yang menggunakan kemampuan tangan untuk
memantulkan, melempar, memukul, dan memasukkan bola ke
0awang. Jika dilihat dengan saksama, cara bermain bola tangan
indoor tampak seperti perpaduan dari bola basket, hoki, dan futsal.
Bola tangan indoor dimainkan oleh dua tim. Setiap tim berjumlah
tujuh orang yang terdiri atas enam pemain dan satu penjaga gawang.Permainan bola tangan pertama kali diperkenalkan sebagai
bagian dari pendidikan jasmani di sekolah-sekolah Jerman oleh
Konrad Koch sekitar tahun 1800-an. Permainan ini terus berkembang
ke seluruh dunia hingga akhirnya terbentuk IHF (International
Handball Federation) pada tahun 1946.
    </p>

    <h1 class="text-lg text-red-700 font-bold mt-5">2. Peraturan Permainan Bola Tangan Indoor</h1>
    <b style="color: black;">A. Lapangan Permainan</b>
    <p class="text-justify">
    permainan dilakukan di sebuah lapangan berbentuk persegipanjang dengan ukuran panjang 40 m x 20 m. Permainan bola tangan indoor menggunakan dua gawang berjaring. Setiap gawang berukuran tinggi 2 meter dan panjang 3 meter.

<img src="{{ url('assets/lapanganindoor.JPG') }}" class="block mx-auto mt-5" alt="">
    <p class="text-center">Gambar 1.2</p>
    </p>

    <b style="color: black;">B. Bola Tangan Indoor</b>
    <p class="text-justify">
    
    Standar bola yang dapat digunakan
dalam permainan bola tangan indoor
harus terbuat dari bahan kulit atau
sintetis. Selain itu, permukaannya tidak
boleh berkilau atau licin
<ul class="ms-8 list-decimal">
                <li>
                Ukuran IHF 2 (54-56 cm dan 325-375 gr). digunakan untuk
perempuan dewasa dan remaja putri di atas usia 14 tahun
                </li>
                <li>
...
<img src="{{ url('assets/bolaindor.jpg') }}" class="block mx-auto mt-5" alt="">
    <p class="text-center">Gambar 1.4</p>
    </p>

    <b style="color: black;">C. Jumlah Pemain</b>
    <p>Terdiri atas 7 pemain inti dan 7 pemain cadangan. Penggantian
pemain di lapangan dapat dilakukan berkali-kali setiap saat.
In tangan indoor.</p>
    <ul class="list-decimal ms-8 text-justify">
       
       
        
        <img src="{{ url('assets/jumlahindor.png') }}" class="block mx-auto mt-5" alt="">
    <p class="text-center">Gambar 1.2</p>
    </ul>
    ...
    Waktu permainan bola tangan indoor adalah 2 x 30 menit, yana
terbagi dalam dua babak. Tempo dalam permainan ini cenderung
lebih cepat dibandingkan dengan bola basket, futsal, atau cabanga
olahraga lainnya. Jika skor permainan berakhir seri dalam waktu
normal, akan ada penambahan waktu (overtime) selama 2 x 5
menit. Namun, jika overtime sudah habis dan hasilnya masih seri,
pemenang akan ditentukan dengan melakukan lemparan dari jarak
7 meter.
<img src="{{ url('assets/waktuindor.png') }}" class="block mx-auto mt-5" alt="">
