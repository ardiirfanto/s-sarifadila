...
@section('content')
    <h1 class="text-xl text-orange-700 font-bold">B. Bola Basket (Basketball)</h1>
    ...
    <h1 class="text-lg text-red-700 font-bold">1. Hakikat Permainan Bola Basket</h1>
    <p class="text-justify">

    Bola basket adalah suatu permainan yang dimainkan oleh dua
regu dengan tiap regu terdiri atas lima pemain. Tujuan permainan
ini adalah membuat nitai sebanyak-banyaknya dengan memasukkan
bola ke keranjang lawan dan mencegah pemain lawan membuat nilal.Pada 1981, Dr,. James A. Naismith mulai menentukan sasaran
berbentuk keranjang yang berlubang di bagian bawah. la mencoba
memasukkan bola pada keranjang yang dipasang pada dinding
gedung. Dari asal keranjang initah nama bola basket yang diciptakan
oleh Dr. James A. Naismith menjadi terkenal hingga ke seluruh dunia
    </p>

    <h1 class="text-lg text-red-700 font-bold mt-5">2. Peraturan Permainan Bola Basket</h1>
    <b style="color: black;">A. Lapangan Permainan</b>
    <p class="text-justify">
Dalam permainan yang sebenarnya atau pertandingan resmi, permainan bola basket dilakukan di sebuah lapangan persegi panjang
dengan ketentuan berikut. 
<ul class="ms-8 list-decimal">
                <li>
                Ukuran lapangan sesuai standar Nasional Basketball Association
adalah panjang 28,5 m dan lebar 15 m.
                </li>
                <li>
                Untuk standar Federasi Bola Basket Internasional adalah panjang
26 m dan lebar 14 m.
                </li>
                <li>
                Terdapat tiga buah lingkaran dalam lapangan basket dengan
panjang jari-jari 1,80 m
                </li>
                <li>
                Tinggi ring basket 2,75 m dengan diameter 0,45 m.
                </li>
                <li>
                Panjang dan lebar papan pantul bagian luar berukuran
1,80 m x 1,20 m.
                </li>
                <li>
                Panjang dan lebar papan pantul bagian dalam berukuran
0,59 m x 0,45 m
                </li>
            </ul>

<img src="{{ url('assets/lapanganbasket.JPG') }}" class="block mx-auto mt-5" alt="">
    <p class="text-center">Gambar 1.2</p>
    </p>

    <b style="color: black;">B. Bola Basket</b>
    <p class="text-justify">
    
    Bola standar yang dapat digunakan dalam
permainan bola basket harus memiliki syarat
berikut.
<ul class="ms-8 list-decimal">
                <li>
                Terbuat dari kulit, karet, atau bahan
sintetis lainnya.
                </li>
                <li>
                Berukuran 7 (keliling lingkaran 749-780 mm
dan berat 567-650 gram) untuk putra.
                </li>
                <li>
                Berukuran 6 (keliling lingkaran 724-737 mm dan berat 510-567 gram) untuk putri.
                </li>
                
            </ul>

<img src="{{ url('assets/bolabasket.png') }}" class="block mx-auto mt-5" alt="">
    <p class="text-center">Gambar 1.4</p>
    </p>

    <b style="color: black;">C. Jumlah Pemain</b>
    <p>Bola basket dimainkan oleh dua tim yang masing-masing terdiri
atas lima orang pemain inti dan lima orang pemain cadangan.
Terdapat tiga posisi utama dalam permainan bola basket, yaitu
forward yang bertugas mencetak poin dengan memasukkan bola
ke keranjang lawan; defense yang bertugas menjaga pemain lawan
agar tidak dapat mencetak angka; dan playmaker yang bertugas
mengatur alur bola dan strategi yang dimainkan oleh timnya.</p>
    <ul class="list-decimal ms-8 text-justify">
       
       
        
        <img src="{{ url('assets/jumlahbasket.png') }}" class="block mx-auto mt-5" alt="">
    <p class="text-center">Gambar 1.2</p>
    </ul>
    ...
    Dibandingkan dengan sepak bola voli. Permainan bola
Tempo permainan bola basket
dibagi menjadi 4 kuarter dengan tiap kuarternya berdurasi
sepak bola atau
10 menit. Tim yang memiliki di akhir kuarter adalah
basket
tim yang berhasil memenangkan permainan.
<img src="{{ url('assets/waktubasket.JPG') }}" class="block mx-auto mt-5" alt="">
