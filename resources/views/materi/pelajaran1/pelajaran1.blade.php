                    ...
                    <div class="card shadow-sm blog-list-card">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="card-blog-content">
                                ...
                                <a class="blog-title d-block mb-3 text-dark">SEPAK BOLA (Football) </a>
                                <button onclick="animateBtnPelajaran('pelmat-1','pelajaran-1/jalan-cepat')"
                ...
                <div class="col-12 col-md-8 col-lg-7 col-xl-6 btn-click" id="pelmat-2">
                    <div class="card shadow-sm blog-list-card">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="card-blog-content">
                                <span class="badge bg-danger rounded-pill mb-2 d-inline-block">Permainan Invasi</span>
                                <a class="blog-title d-block mb-3 text-dark">BOLA BASKET
                                    (BASKET BALL)</a>
                                <button onclick="animateBtnPelajaran('pelmat-2','pelajaran-1/lari-jarak-pendek')" class="btn btn-primary btn-sm">BUKA MATERI</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-8 col-lg-7 col-xl-6 btn-click" id="pelmat-3">
                    <div class="card shadow-sm blog-list-card">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="card-blog-content">
                                <span class="badge bg-danger rounded-pill mb-2 d-inline-block">Permainan Invasi</span>
                                <a class="blog-title d-block mb-3 text-dark">BOLA TANGAN
                                    INDOOR</a>
                                <button onclick="animateBtnPelajaran('pelmat-3','pelajaran-1/lompat-jauh')" class="btn btn-primary btn-sm">BUKA MATERI</button>
                            </div>
                        </div>
                    </div>
                </div>
