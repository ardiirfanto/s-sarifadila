        ...
        <div class="p-4 mb-20 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            @if (session('status'))
                <div id="toast-top-right"
                    class="fixed z-50 flex items-center w-full max-w-xs p-4 space-x-4 divide-x rtl:divide-x-reverse top-5 right-5"
                    role="alert">
                ...
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-4 md:p-5 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Yakin akan keluar?
                            </h3>
                            <button onclick="window.location.href = '/logout'" data-modal-hide="logout-modal"
                                type="button"
