<div>
    ...
    <select id="pelajaran" wire:model.live='sorting'
                ...
                @foreach ($data as $item)
                    <tr wire:key='{{ $item->id }}' class="bg-white border-b dark:bg-gray-800 dark:border-gray-700"
                        ...
                        <td class="px-6 py-4 flex items-center gap-4">
                            <a href="/dashboard/detail-kuis/{{ $item->id }}"
                            ...
                            <button data-modal-target="popup-modal" wire:click='hapus({{ $item->id }})'
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Yakin akan hapus kuis ini?
                    </h3>
