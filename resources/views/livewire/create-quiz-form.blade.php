<div>
    <div class="w-full bg-white py-8 px-3">
        <form class="md:w-2/3 lg:w-1/2 w-full mx-auto" wire:submit='submit'>
            @if (session('failed'))
            ...
            <div class="mb-5">
                <label for="code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Buat Kode</label>
                <input type="text" wire:model='code' id="code" placeholder="Cth: BJuNLaKlN" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                <div class="flex justify-end mt-3">
                    <button type="button" wire:click='generateCode' class="flex items-center p-2 gap-2 font-semibold text-white rounded-lg bg-gray-700">
                        <svg class="sm:w-6 w-4 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="sm:text-base text-sm">Generate Code</span>
                    </button>
                </div>
            </div>
