    ...
    <div class="grid xl:grid-cols-2 grid-cols-1 gap-3">
        @foreach ($data as $item)
            <div class="relative shadow-lg p-3">
                ...
                <button wire:click='hapus({{ $item->id }})' data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="absolute top-2 right-2 block ms-auto text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm p-1 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" type="button">
                    <svg class="w-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Yakin hapus video ini?</h3>
