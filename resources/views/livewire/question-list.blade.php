<div>
    ...
    <div class="container">
      <div class="card">
        ...
        <ul class="list-decimal ms-12">
            @foreach ($data as $item)
                <div class="flex items-center space-x-2">
                    <svg wire:click='tambahOption({{ $item->id }})' data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="w-6 h-6 text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <svg wire:click='editSoal({{ $item->id }})' data-modal-target="edit-modal" data-modal-toggle="edit-modal" class="w-6 h-6 text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <svg wire:click='hapus({{ $item->id }})' class="w-6 h-6 text-rose-700" data-modal-target="hapus-modal" data-modal-toggle="hapus-modal" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                ...
                <li class="mb-8">
                    {{ $item->pertanyaan }}
                    @if ($item->gambar)
                        <img src="{{ url('storage/soal/gambar/'. $item->gambar) }}" class="w-32" alt="">
                    @endif
                    <ul class="list-huruf mt-2 ms-4">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" wire:submit='submit'>
                        <div>
                            <label for="option" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pilihan</label>
                            <input type="text" name="option" wire:model='option' id="option" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Isi pilihan disini...">
                        </div>
                        <div>
                            <label for="nilai" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bobot Nilai</label>
                            <input type="number" name="nilai" oninput="validate()" wire:model.live='nilai' id="nilai" placeholder="Cth: 10" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                        </div>
    ...
    <div wire:ignore.self id="edit-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <div class="p-4 md:p-5">
                    <form class="max-w-sm mx-auto" wire:submit='submitSoal'
    ...
    {{-- Modal Hapus Soal --}}
    <div wire:ignore.self id="hapus-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Yakin akan hapus soal ini?</h3>
                    <button wire:click='hapusConfirm' data-modal-hide="hapus-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                        Ya, saya yakin
                    </button>
