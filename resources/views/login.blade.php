...
<body>
    ...
    <div class="hero-block-wrapper bg-dark">
        ...
        <div class="custom-container">
            ...
            <div class="hero-block-content">
                ...
                <h2 class="display-4 text-white mb-3">Media Pembelajaran Pengelasan FCAW</h2>
                <p class="text-white">Media Pembelajaran ini di buat berdasarkan buku Indaryanto
                    Agung Rahayu.</p>
    ...
    <script src="{{ asset('js/btn-click.js') }}"></script> {{-- Efek Sound Button --}}
